    ...
    <div class="row">
      ...
      <div class="col-6">
        <div class="d-flex justify-content-between headers">
          <h4>싸피게시판</h4>
          <h4 class="showMore" @click="clickSSAFYBoard">+</h4>
        </div >
        <!-- v-for 사용해 게시판 최신글 (4~5개) 노출시키기 -->
        <div v-for="article in ssafyArticles" :key="article.id">
      ...
      <div class="col-6">
        <div class="d-flex justify-content-between headers">
          <h4>자유게시판</h4>
          <h4 class="showMore" @click="clickFreeBoard">+</h4>
        </div>
        <!-- v-for 사용해 게시판 최신글 (4~5개) 노출시키기 -->
        <div v-for="article in freeArticles" :key="article.id">
          <div class="d-flex justify-content-between">
            <p>{{ article.title }} </p>
            <p>{{ article.author.username }}</p>
          </div>
